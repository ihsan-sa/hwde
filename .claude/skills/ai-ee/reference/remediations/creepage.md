...
## Verify
```
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\check_creepage.py --pcb boards\<name>\kicad\<name>.kicad_pcb --constraints boards\<name>\kicad\constraints.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\gate.py --gate verify boards\<name>\kicad\<name>.kicad_pcb
```
