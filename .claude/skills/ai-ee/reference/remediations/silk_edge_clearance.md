...
## Verify
```
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\place_edit.py --pcb boards\<name>\kicad\<name>.kicad_pcb --ops work\silk_ops.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\kc.py drc boards\<name>\kicad\<name>.kicad_pcb --parity --all-track-errors --out work\drc_after.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\gate.py --gate drc_routed boards\<name>\kicad\<name>.kicad_pcb
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\render.py boards\<name>\kicad\<name>.kicad_pcb --views top --out-dir work\silk_render
```
