...
```
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\route_edit.py --pcb <ws>\kicad\<board>.kicad_pcb --ops <ws>\work\widen_ops.json --out-report <ws>\work\widen_report.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\gate.py --gate dfm <ws>\kicad\<board>.kicad_pcb --out <ws>\work\dfm_after.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\gate.py --gate drc_routed <ws>\kicad\<board>.kicad_pcb --out <ws>\work\drc_after.json
.venv\Scripts\python.exe .claude\skills\ai-ee\scripts\dfm_check.py --pcb <ws>\kicad\<board>.kicad_pcb --out <ws>\work\dfm_facts.json
```
...
- .claude/skills/ai-ee/scripts/dfm_check.py:125-139, :84-87, :547, :557
- .claude/skills/ai-ee/scripts/lib/gerblib.py:121-151
- .claude/skills/ai-ee/scripts/gate.py:74-87, :130-141
- .claude/skills/ai-ee/scripts/kc.py:221-232
- .claude/skills/ai-ee/scripts/route_edit.py:11-30, :52
- .claude/skills/ai-ee/scripts/cluster_violations.py:61, :144-160
- .claude/skills/ai-ee/scripts/fix_dispatch.py:46-61
- .claude/skills/ai-ee/reference/gates.yaml:104-118
- .claude/skills/ai-ee/reference/jlc_capabilities.yaml:34, :52, :70, :88, :106
