...
## buck-bst-fb-output-caps [feedback, decoupling]
...
## buck-cin-co-ground-separation [power-loop, emi]
...
## buck-constraints-emission [constraints-emission]
...
## buck-en-softstart-sequencing [sequencing]
...
## buck-freewheel-diode-snubber-placement [power-loop, emi]
...
## buck-inductor-copper-and-gnd-void [emi]
...
## buck-inductor-selection [selection]
...
## buck-input-hot-loop [power-loop, emi]
...
## buck-power-ground-isolation [return-path, power-loop]
...
## buck-selection-ladder [selection]
...
## buck-switch-node-containment [emi]
...
## buck-thermal-via-and-via-current [thermal-via]
...
## buck-upstream-inrush-limit [inrush, selection]
