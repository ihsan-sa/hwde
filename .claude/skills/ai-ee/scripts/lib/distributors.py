...
Credentials (env vars):
    AIEE_DIGIKEY_CLIENT_ID + AIEE_DIGIKEY_CLIENT_SECRET
        ...
        the OAuth2 client-credentials token call takes. AIEE_DIGIKEY_SANDBOX=1
...
DIGIKEY_ENV = ("AIEE_DIGIKEY_CLIENT_ID", "AIEE_DIGIKEY_CLIENT_SECRET")
MOUSER_ENV = ("AIEE_MOUSER_API_KEY",)
...
REGISTER = {
    "digikey": ("register at developer.digikey.com (My Apps -> create app "
                ...
                "AIEE_DIGIKEY_CLIENT_ID + AIEE_DIGIKEY_CLIENT_SECRET; set "
                "AIEE_DIGIKEY_SANDBOX=1 to use sandbox-api.digikey.com keys"),
...
TIMEOUT = 30.0
USER_AGENT = "ai-ee research (distributor client)"
...
def missing_credentials(provider: str) -> list[str]:
    ...
    return [v for v in ENV[provider] if not os.environ.get(v)]
...
class DigiKeyClient:
    ...
    def from_env(cls, transport=None) -> "DigiKeyClient":
        ...
        return cls(os.environ["AIEE_DIGIKEY_CLIENT_ID"],
                   os.environ["AIEE_DIGIKEY_CLIENT_SECRET"],
                   transport=transport,
                   sandbox=os.environ.get("AIEE_DIGIKEY_SANDBOX") == "1")
...
class MouserClient:
    ...
    def from_env(cls, transport=None) -> "MouserClient":
        ...
        return cls(os.environ["AIEE_MOUSER_API_KEY"], transport=transport)
